...
function SignUpForm() {
  ...
  async function handleGoogleSignUp() {
    ...
    // Supabase env vars are missing and nothing caught it, and the { error } from
    // signInWithOAuth was discarded. Both looked identical to the user — a button
    ...
    try {
      ...
      setError(envErr?.message ?? 'Authentication is not configured on this deployment.')
      setGoogleLoading(false)
      return
    }

    // Only forward the ids that were actually collected. A Department Chair sent
    // "department_id=&program_id=" — empty params the callback then had to ignore,
